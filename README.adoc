...
Esta imagen se puede obtener desde https://hub.docker.com/r/labcabrera/tariff-calculator-gateway/tags/.

== Kubernetes

IMPORTANT: No PAAS no honey

== OpenShift

En este https://github.com/labcabrera/http-network-diagnostic[repositorio] se explica brevemente
cómo desplegar una microservicio con Spring Boot en OpenShift.
